@extends('layouts.app')
@section('title', 'Edit SMS Automations')
@section('content')
                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb" class="float-right mt-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Edit SMS Automation</li>
                            </ol>
                        </nav>
                        <h4 class="mb-1 mt-0">Edit SMS Automation</h4>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" action="{{ url('edit-sms-automation-post/'.$smsseries->id) }}" method="POST" name="save_sms_automation" onsubmit="return validateMsg()">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="series_name" class="form-control" placeholder="Name of the event" autocomplete="off" required value="{{ $smsseries->series_name }}">
                                            </div>
                                            ...
                                            <div class="card border border-primary">
												...
												<div id='unEditable' style="width: fit-content;padding-right:10px;contenteditable="false" unselectable="off" onkeyup="" >Dear</div>
                                                    <!-- <textarea name="message" id="message" rows="8" style="width:100%;" required onkeyup="Msg_show_textarea(), countChar(this)" maxlength="130">{{ $smsseries->message }}</textarea> -->
                                               <textarea name="message" id="message" rows="8" style="width:100%;" required onkeyup="Msg_show_textarea()" maxlength="160">{{ $smsseries->message }}</textarea>
												</div>
                                                ...
                                                <div class="hl_sms-preview-body" style="overflow-y: auto;">
                                                    <div class="message-wrap">
                                                        <div class="--sm avatar">
                                                            ...
                                                            <div class="message-bubble" style="background-color: rgb(24, 139, 246); word-break: break-word;"> Dear <p id="msgshow" > </p></div>
                                                            <!---->
                                                        </div>
                                                        <!---->
                                                    </div>
