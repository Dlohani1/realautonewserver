@extends('layouts.app')
@section('title', 'SubAdmin Add New Leads')
@section('content')
            ...
            <div class="container-fluid">
                <div class="row page-title">
                    <div class="col-md-12">
                        ...
                        <h4 class="mb-1 mt-0">SubAdmin Add Leads</h4>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" action="<?php echo url('/save-leads-subadmin'); ?>" method="post" name="add-leads-post-data" class="form-horizontal" onsubmit="return 
checkDigit()">
                                    @csrf
                                    ...
                                    <div class="form-group row mb-3 {{ $errors->has('name')? 'has-error':'' }}">
                                        ...
                                        <div class="col-6">
                                            <input id="fullname" type="text" name="name" class="form-control" placeholder="Name" value="{{ old('name') }}" onkeyup="myName()" 
autocomplete="off">
                                    ...
                                    <div class="form-group row mb-3 {{ $errors->has('mail_id')? 'has-error':'' }}">
                                        ...
                                        <div class="col-6">
                                            <input id="email" title="abc@gmail.com" type="email" name="mail_id" class="form-control" placeholder="Email" value="{{ old('mail_id') }}" 
onkeyup="myEmail()" autocomplete="off">
                                    ...
                                    <div class="form-group row mb-3 {{ $errors->has('mobile_no')? 'has-error':'' }}">
                                        ...
                                        <div class="col-6">
                                            <input id="mobno" type="text" name="mobile_no" class="form-control" placeholder="Mobile" value="{{ old('mobile_no') }}" onkeyup="myMobile()" 
maxlength="10" autocomplete="off">
                                    ...
                                    <div class="form-group row mb-3" id="hideprojects_name" style="display: none;">
                                        ...
                                        <div class="col-6">
                                            <input type="text" name="project_name" id="projectnametext" class="form-control" onkeyup="myProjectnametext()" placeholder="Enter New 
Project Name" autocomplete="off">
                                    ...
                                    <div class="form-group row mb-3 {{ $errors->has('segment_name')? 'has-error':'' }}" id="hidesegment_name" style="display: none;">
                                        ...
                                        <div class="col-6">
                                            <input type="text" name="segment_name" id="segmentnametext" class="form-control" onkeyup="mySegmentnametext()" placeholder="Enter New 
Segment Name" autocomplete="off">
