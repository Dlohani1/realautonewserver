...
<div class="container">
 <div class="row page-title">
                    <div class="col-md-12">
                        ...
                        <h4 class="mb-1 mt-0">Edit Account Settings</h4>
                    </div>
                </div>
<div class="row justify-content-center">
    <div class="col-12 col-lg-10 col-xl-8 mx-auto" style="margin-top:50px">
        <h2 class="h3 mb-4 page-title"> Edit Settings</h2>
        <div class="my-4">
            ...
            <div class="list-group mb-5 shadow">
               <div class="list-group-item">
                    <div class="row align-items-center">
                        <div class="col">
                            <strong class="mb-2">Enable Auto-Assigned Leads</strong>
							<?php
							if ($isAutoAssign > 0) {?>
  ...
  <span class="slider round"></span>
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        <div class="col">
                            <strong class="mb-2">Send New Lead Notifications to Team</strong>
                            <?php
                                                        if ($sendStaff > 0) {?>
...
var formData = {_token: "{{ csrf_token() }}",fieldName:fieldName,status:switchStatus}; //Array 
