            ...
            <div class="container-fluid">
                <div class="row page-title">
                    <div class="col-md-12">
                        ...
                        <h4 class="mb-1 mt-0">Automated Lead Assign Settings</h4>
<p>Click the projet from the <span style="color:red"> Left box </span> and select the staff from <span style="color:red">Rigt box</span> to assign the leads automatically & 
accordingly</p>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?php echo url('/auto-lead-assign'); ?>" method="post" name="save-admin" class="form-horizontal">
									...
									<div class="col-md-6">
										...
										<div style="overflow-y: scroll; height:200px;border: 1px solid #e6e6e6;
    margin-bottom: 10px;">
										<?php $i = 0; ?>
