...
onlogin="checkLoginState();"></div>
 	 ...
 	 <div class="form-group row mb-3 {{ $errors->has('project_type')? 'has-error':'' }}">
       ...
       <div class="form-group row mb-3 {{ $errors->has('campaign_id')? 'has-error':'' }}">
		<label for="inputPassword5" class="col-3 col-form-label">Name <span class="required">*</span></label>
		<div class="col-6">
...
<div class="form-group row mb-3 {{ $errors->has('campaign_id')? 'has-error':'' }}">
		<label for="inputPassword5" class="col-3 col-form-label">Phone <span class="required">*</span></label>
		<div class="col-6">
	...
	<div class="form-group row mb-3 {{ $errors->has('campaign_id')? 'has-error':'' }}">
		<label for="inputPassword5" class="col-3 col-form-label">Other Fields <span class="required">*</span></label>
		<div class="col-6">
...
if (undefined !== response.paging.next) {
