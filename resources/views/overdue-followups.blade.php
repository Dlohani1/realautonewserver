@extends('layouts.app')
@section('title', 'Overdue Leads Followup')
@section('content')
                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb" class="float-right mt-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Overdue Leads Followup</li>
                            </ol>
                        </nav>
                        <h4 class="mb-1 mt-0">Overdue Leads Followup</h4>
                    </div>
                </div>
...
function refreshLeads() {
			...
			ajax: "{{url('overdue-followups-retrival')}}",
			columns: [
				{  data: null },
				{  data: "project_name"},
				                                { data: null,
