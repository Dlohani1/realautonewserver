                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb" class="float-right mt-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Bulk WhatsApp Automation</li>
                            </ol>
                        </nav>
                        <h4 class="mb-1 mt-0">Create Bulk WhatsApp Automation</h4>
                    </div>
                </div>
                                            ...
                                            <div class="card border border-primary">
                                                <div class="card-header">
                                                    <div class="row">
														...
														<a style="padding:10px" href="#" onclick="insertAtCaret('message', '{Full Name}');return false;"> Full Name </a>
                                                    </div>
                                                </div>
                                                <div>
