                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ url('edit-whatsapp-automation-post/'.$smsseries->id) }}" method="POST" name="edit_whatsapp_automation_post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <input type="text" name="series_name" class="form-control" placeholder="Name of the event" autocomplete="off" value="{{ $smsseries->series_name }}">
                                            </div>
                                            ...
                                            <div class="row" id="show_delivery_day_time" @if($smsseries->delivery_type == 'scheduled') style="display: flex;" @else style="display: none;"  @endif >
                                            ...
                                            <div class="card border border-primary">
                                                ...
                                                <div >
                                                    <textarea name="message" rows="8" style="width:100%;" id="message" required onkeyup="Msg_show_textarea()">{{ $smsseries->message }}</textarea>
                                                </div>
                                            ...
                                            <div class="form-group row mt-3">
                                                ...
                                                {{--<input type="file" name="image1" class="form-control" id="imgInp"> --}}
													...
													<label id="label1" class="col-lg-4 col-form-label" for="example-fileinput" style="display:none";>Attach File Link</label>
													<input id="file1" type="file" class = "form-control"  style="display:none"; onchange="storeFile(this)" />
													<span id="uploadMsg1" style="color:green;"></span>
													<?php
													if (null == $smsseries->image) { ?>
													<label class="col-lg-4 col-form-label" for="example-fileinput">Attach File Link</label>
													<input id="attachment1" type="file" class = "form-control"  onchange="storeFile(this)" />
													<!--<button type="button" onclick="storeFile()">Upload</button> -->
													<span id="uploadMsg" style="color:green"></span>
													<span style="color:blue"> *Supported files are jpeg,png,doc,excel,pdf. Upload upto 2MB </span>
													<?php } else {
														$base_link = "https://realauto.in/";
														if(strlen($smsseries->image) > 0 && strpos($smsseries->image, $base_link) !== false){

														} else {
															$smsseries->image = $base_link.$smsseries->image;
														}
														//echo $smsseries->image;
														?><a id="viewFile" href="{{$smsseries->image}}" target="_blank">View </a> <button id="rmvbtn" type = "button" onclick="showfileupload()"> Remove Attachment </button> <?php } ?>  
												</div>
                                            </div>
                                                    ...
                                                    <div class="message-wrap">
                                                        <div class="--sm avatar">
                                                            ...
                                                            <div class="message-bubble" style="background-color: rgb(24, 139, 246); word-break: break-word;">
                                                                <img id="blah" src="{{ url('/uploads/automation/'.$smsseries->image) }}" style="width:100px; height:100px; display:none;" />
