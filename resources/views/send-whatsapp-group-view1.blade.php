@extends('layouts.app')
@section('title', 'Send Whatsapp Group')
@section('content')
                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb" class="float-right mt-1">
                         ...
                         <li class="breadcrumb-item"><a href="{{ url()->previous() }}"> Manage Events </a></li>
                                <li class="breadcrumb-item active" aria-current="page">Send Whatsapp to Group</li>
                            </ol>
                        </nav>
                        <h4 class="mb-1 mt-0">Send Whatsapp to Group</h4>
                    </div>
                </div>
...
of the event" autocomplete="off">
                                            ...
                                            <div class="form-group" style="display: none;">
                                                <select name="delivery_type" data-plugin="customselect" class="form-control" 
onchange="getAfterValue(this.value)">
                                                    <option value="initial">Immediate</option>
                                                    <option value="scheduled">After</option>
                                                </select>
                                            </div>

                                            <div class="row" id="show_delivery_day_time" style="display: none;" >
                                                <div class="form-group col-6">
                                                    <input type="number" name="delivery_day" min="0" class="form-control" 
placeholder="Delivery Day" autocomplete="off" >
                                                </div>
                                                <div class="form-group col-6">
                                                    <input type="text" name="delivery_time" class="form-control bs-timepicker" 
placeholder="Delivery Time" autocomplete="off" >
                                                </div>
                                            </div>
...
<option value="0">Select Recievers</option>
<option value="1">Mobile Nos </option>
...
<div class="form-group">
    <input class="form-control"" type="text" id="mobnos" style="display:none" placeholder="Enter recipient nos without +91 and 
separated by comma" />
</div>
...
height: calc(4 * 38px)}" class="form-control">
...
type="button" onclick="storeFile()">Upload</button> -->
													<span 
style="color:blue"> *Supported files are jpeg,png,doc,excel,pdf. Upload upto 2MB </span>
													<br/><span 
...
246); word-break: break-word;"><img id="blah" src="#" style="width:100px; height:100px; display:none;" /><p id="msgshow">  
                                        ...
                                        <div class="col-12" style="display:none">    
											<input type="number" 
class="form-control mb-2 mr-sm-2" placeholder="Enter Phone No" id="mobNo" onkeydown="javascript: return event.keyCode === 8 || 
...
text-danger font-size-12'></i> by <a href="#" target="_blank">Realauto</a>
                    </div>
                </div>
            </div>
        </footer>
...
function testWhatsapp() {
    ...
    if (no < 1) {
    	...
    	var formData = {_token: "{{ csrf_token() }}",isGroup:isGroup,group:group,msg:msg,attachment:attachment}; 
