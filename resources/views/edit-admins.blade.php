                                ...
                                <div id="collapseOne" class="panel-collapse collapse in">
                                    <div class="panel-body">
										<div class=" row ">
											...
											Do you want to send login credentials whatsapp & email ? <input type="radio" name="sendLoginDetails" value="1" >Yes <input type="radio" name="sendLoginDetails" checked value="0">No 
											</div>
										</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            Yes <input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="yesCheck" value="1" > No <input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="noCheck" checked value="2">
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group row mb-3">
												  <label for="inputEmail3" class="col-3 col-form-label">Plans<span class="required">*</span></label>
													...
													<select name="user-plans" onchange="changeUserPlan()" id="user_plans" class="form-control custom-select mb-2" required>
														...
														<option value="1" <?php if ($admindata->user_plans_id == "1") {echo "selected";} ?> >15 Days</option>
														<option value="2" <?php if ($admindata->user_plans_id == "2") {echo "selected";} ?>>1 month</option>
														<option value="3" <?php if ($admindata->user_plans_id == "3") {echo "selected";} ?>>3 Months</option>
														<option value="4" <?php if ($admindata->user_plans_id == "4") {echo "selected";} ?>>6 Months</option>
														<option value="5" <?php if ($admindata->user_plans_id == "5") {echo "selected";} ?>>3 Days (Trial Plan)</option>
													</select>
													</div>
                                                </div>
                                                <div class="form-group row mb-3">
												  <label for="inputEmail3" class="col-3 col-form-label">Start Date / End Date<span class="required">*</span></label>
													<div class="col-4">
														<input type="date" name="start_date" id="start_date" value="{{$admindata->start_date}}"  onchange="setEndDate()" name="start_date" class="form-control"  />
													</div>
													<div class="col-4">
														<input type="date" id="end_date" name="end_date" value="{{$admindata->end_date}}" class="form-control" placeholder="End Date" readonly />
													</div>												
												</div>
											</div>
										</div>
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse">
                                    <div class="panel-body">
                                          ...
                                          <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row mb-3">
												  <label for="inputEmail3" class="col-3 col-form-label">Whatsapp Plans<span class="required">*</span></label>
												<div class="col-9">
                                                  <select name="whatsapp-plans" class="form-control custom-select mb-2" >
													<option value="0" >Select Plan</option>
													<option value="1" <?php if ($admindata->whatsapp_plans_id == "1") {echo "selected";} ?>>15 Days</option>
													<option value="2" <?php if ($admindata->whatsapp_plans_id == "2") {echo "selected";} ?>>1 Month</option>
													<option value="3" <?php if ($admindata->whatsapp_plans_id == "3") {echo "selected";} ?>>3 Months</option>
													<option value="4" <?php if ($admindata->whatsapp_plans_id == "4") {echo "selected";} ?>>6 Months</option>
													<option value="5" <?php if ($admindata->whatsapp_plans_id == "5") {echo "selected";} ?>>1 Year</option>
												</select>
												
												Do you want to call the Whatsapp Change Plan Api ? <input type="radio" name="isChangePlan" value="1" >Yes <input type="radio" name="isChangePlan" checked value="0">No 
												</div>
                                                </div>
                                                 <div class="form-group row mb-3">
                                                ...
                                                <div class="form-group row mb-3">
												 <label for="inputEmail3" class="col-3 col-form-label">Whatsapp API Username<span class="required">*</span></label>
												<div class="col-9">
                                                    <input type="text" name="whatsapp_username" value="{{$admindata->whatsapp_username}}" class="form-control" placeholder="Whatsapp Username"  />
                                                </div>
												</div>
                                            </div>
                                        </div>
