                            ...
                            <div class="card-body">
                                <h5>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#myModal"
                                        ...
                                        <i data-feather="plus" class="icons-sm"></i><strong>Add New Event</strong></a>
                                </h5>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="card-footer">
                                                        <div class="row">
                                                            <div class="col-md-9 mt-2">
                                                                ...
                                                                @else
                                                                    <a href="{{ url('copy-whatsapp-automation-campaign/' . $data->id) }}"><i data-feather="copy" 
class="icons-sm"></i></a>
                                                                @endif
																<?php 
																$cronEvent = 0;
																if(!empty($data->delivery_day) || $data->delivery_day != 
0 || $data->delivery_time != 0) {
																	$cronEvent = 1;
																}
																 ?>
																<div class="onoffswitch" style="margin-top:10px">
																	<input type="checkbox" name="onoffswitch" 
class="onoffswitch-checkbox" id="myonoffswitch{{$sl}}" tabindex="0" onclick="deactivateEvent('myonoffswitch{{$sl}}',{{$data->id.','.$data->is_active.','.($data->is_active == 0 ? 
'1':'0').','.$cronEvent}})" {{$data->is_active == 1 ? "checked":""}} >
																	<label class="onoffswitch-label" 
for="myonoffswitch{{$sl}}">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                @if(!empty($data->delivery_day) || $data->delivery_day != 0 || $data->delivery_time != 0)
                                                                    <?php  if ($data->delivery_day) { switch($data->delivery_day) { case 1 : $sup = "st"; break; case 2: $sup = "nd"; 
break; case 3: $sup = "rd"; break; default : $sup = "th";} echo "$data->delivery_day<sup>$sup</sup>"; } else {echo "Same ";}?> Day | Time {{ date('h:i A', 
strtotime($data->delivery_time)) }}
                                                                @else
                                                                    Immediate
                                                                @endif
                                                            </div>
                                ...
                                @endforeach
                               <!-- <li><div class="ad_sp"><a href="#myModal" data-toggle="modal" data-target="#myModal" class="modal-title"><i data-feather="plus-circle" 
class="icon-dual"></i><span>Add Events</span></a></div></li>-->
                            </ul>
                        </div>
                    </div>
                </div>
