                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb" class="float-right mt-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">My Referrels</li>
                            </ol>
                        </nav>
                        <h4 class="mb-1 mt-0">My Referrels</h4>
                    </div>
                </div>
...
$(document).ready(function() {
    var t = $('#example').DataTable( {
      processing: true,
      serverSide: true,
      ajax: "{{url('usersAssignedReferrel')}}",
