...
class="uil-plus mr-1"></i></button>
                                 <button class="btn btn-primary mt-1 mr-1 pull-right" id="btn-new-event" onclick="sendImmediate()"> Send Immediate </button>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
            ...
            <tbody>
                <tr>
                    <td colspan="20" class="page-header"><button type="button" class="tbtn"><i class="fa fa-plus-circle fa-minus-circle"></i>   {{$value->series_name}}</button> </td>
                </tr>
                <tr class="toggler toggler1">
                    ...
                    <td>{{$value->delivery_date_time}}</td>
                    <td><?php echo $value->is_delivered == "1" ? "Delivered" : "Not Delivered";?></td>
                    <!--<td>0</td>
                    <td>0</td>
                    <td>12</td>
                    <td>23</td>
