                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?php echo url('/edit-subadmin-lead-post/'.$leadsdata->id); ?>" method="post" name="add-leads-post-data" class="form-horizontal">
                                    @csrf
                                    ...
                                    <div class="form-group row mb-3" id="hideprojects_list">
                                        ...
                                        <div class="col-6">
                                            <select name="project_id" class="custom-select mb-2" >
                                                ...
                                                <option value="{{ $rowproject->id }}" @if($rowproject->id == $leadsdata->project_id) selected @endif>{{ $rowproject->project_name 
}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row mb-3" id="hidesegment_list" >
                                        ...
                                        <div class="col-6">
                                            <select name="segment_id" class="custom-select mb-2" >
                                                ...
                                                <option value="{{ $rowsegments->id }}" @if($rowsegments->id == $leadsdata->segment_id) selected @endif>{{ $rowsegments->segment_name 
}}</option>
                                                @endforeach
                                            </select>
                                        </div>
