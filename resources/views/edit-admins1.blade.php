                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?php echo url('/edit-admins-post/'.$admindata->id); ?>" method="post" name="edit-admins-post" class="form-horizontal">
                                    @csrf
                                    ...
                                    <div class="form-group row mb-3">
                                        <label for="inputPassword5" class="col-3 col-form-label">Whatsapp <span class="required">*</span></label>
                                        <div class="col-6">
                                            <select name="whatsapp_api_key_lock" class="custom-select mb-2" required onchange="showApi('whatsapp',this.value)">
                                                <option value="1" @if($admindata->whatsapp_api_key_lock == 1) selected @endif >UnLock</option>
                                                <option value="2" @if($admindata->whatsapp_api_key_lock == 2) selected @endif>Lock</option>
                                            </select>
                                        </div>
                                    </div>
									<div id="whatsapp-api-key" @if($admindata->whatsapp_api_key_lock == 2) style="display:none" @endif> 
										<div class="form-group row mb-3" >
											<label for="inputEmail3" class="col-3 col-form-label">Whatsapp API Key <span class="required">*</span></label>
											<div class="col-6">
												<input type="text" name="whatsapp-api-key" class="form-control" placeholder="API Key"  value="{{ $admindata->whatsapp_api_key }}">
											</div>
										</div>
										<div class="form-group row mb-3" >
											<label for="inputEmail3" class="col-3 col-form-label">Whatsapp Username <span class="required">*</span></label>
											<div class="col-6">											
												<input type="text" name="whatsapp-username" class="form-control" placeholder="Whatsapp Username"  value="{{ $admindata->whatsapp_username }}">
											</div>
										</div>
									</div>
                                    <div class="form-group row mb-3" >
                                        <label for="inputPassword5" class="col-3 col-form-label">Email <span class="required">*</span></label>
                                        <div class="col-6">
                                            <select name="email_api_key_lock" class="custom-select mb-2" required onchange="showApi('email',this.value)">
                                                <option value="1" @if($admindata->email_api_key_lock == 1) selected @endif >UnLock</option>
                                                <option value="2" @if($admindata->email_api_key_lock == 2) selected @endif>Lock</option>
                                            </select>
                                        </div>
                                    </div>
									<div class="form-group row mb-3" id="email-api-key" @if($admindata->email_api_key_lock == 2) style="display:none" @endif>
                                    ...
                                    <div class="form-group row mb-3">
                                        <label for="inputPassword5" class="col-3 col-form-label">Sms <span class="required">*</span></label>
                                        <div class="col-6">
                                            <select name="sms_api_key_lock" class="custom-select mb-2" required onchange="showApi('sms',this.value)">
                                                <option value="1" @if($admindata->sms_api_key_lock == 1) selected @endif >UnLock</option>
                                                <option value="2" @if($admindata->sms_api_key_lock == 2) selected @endif>Lock</option>
                                            </select>
                                        </div>
                                    </div>
									<div id="sms-api-key"  @if($admindata->sms_api_key_lock == 2) style="display:none" @endif>
										<div class="form-group row mb-3" >
                                    ...
                                    <div class="form-group row mb-3">
									 ...
									 <div class="form-group row mb-3">
                                        ...
                                        <div class="col-6">
                                           Yes <input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="yesCheck" value="1" > No <input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="noCheck" checked value="2"><br>
											<div id="ifYes" style="visibility:hidden">
											   <strong> Password : </strong> <input type="text" name="pwd" class="form-control" placeholder="Enter Password"  value=""><br>
											</div>
                                        </div>
                                    </div>
